...
#data pre-processing
ingredients_df = pd.read_csv('db/datas/ingredients.csv', sep=";")
recipes_df = pd.read_csv('db/datas/recipes_new.csv',sep=";")
...
def recommender(recipe_name):
    ...
    # print("                   ")
    # print("recommended recipe 2:", reco_second, ingredients_reco_second)
    return both_recos
